...
[EchoBot](https://huggingface.co/spaces/simonguest/echobot){.external target="_blank"} is a model that can be easily fine-tuned with small (few-shot) datasets without a lot of GPU overhead. It is designed to teach students how fine-tuning works, what's possible, and what its limitations are.
...
Yes! EchoBot is hosted on a Hugging Face Space here: [https://huggingface.co/spaces/simonguest/echobot](https://huggingface.co/spaces/simonguest/echobot){.external target="_blank"}. You can also click on the [Files](https://huggingface.co/spaces/simonguest/echobot/tree/main){.external target="_blank"} tab to investigate the source code.
